...
return (
    <div className="bg-white rounded shadow hover:shadow-2xl p-3 flex flex-col">
        ...
        <div className="mt-3 flex items-center justify-between">
            ...
            <div className="flex flex-col gap-2">
                <button
                    onClick={addToCart}
                    className="flex items-center gap-2 bg-gray-600 hover:bg-gray-800 text-white px-4 py-2 rounded">
